...
def apply_kerberos_config(service, env_var)
  # rubocop:disable LineLength
  node.default['confluent'][service]['env_vars'][env_var] = "-Djava.security.auth.login.config=#{node['confluent']['install_dir']}/confluent-#{node['confluent']['version']}/jaas.conf" if node['confluent']['kerberos']['enable']
